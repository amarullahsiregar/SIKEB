...
public class Login_Admin  extends javax.swing.JFrame {
    ...
    private JLabel tutupButton,usernameBg,passwordBg,usernamelabel,passwordlabel;
    ...
    private void initComponents() {
        ...
        usernamelabel.setBounds(230, 120, 100, 35);
        getContentPane().add(usernamelabel);
        
        passwordlabel.setFont(usernamelabel.getFont());
        passwordlabel.setForeground(usernamelabel.getForeground());
        passwordlabel.setText("password");
        passwordlabel.setBounds( usernamelabel.getBounds().x, 220, usernamelabel.getBounds().width, usernamelabel.getBounds().height);
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {                                      
        try {                                         
            ...
            ResultSet benar = konek.createStatement().executeQuery("select * from pengguna where id_pengguna='"+usernameForm.getText()+"'and password='"+String.valueOf(passwordForm.getText())+"' and aktif=1 ");
            ResultSet usrbnr = konekuser.createStatement().executeQuery("select * from pengguna where id_pengguna='"+usernameForm.getText()+"'");
            if(benar.next()){
